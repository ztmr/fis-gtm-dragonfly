...
GDEINIT
  ...
  s endian("x86_64","Linux")=FALSE,endian("x86_64","FreeBSD")=FALSE,endian("x86_64","DragonFly")=FALSE
	s glo("SCO")=384,glo("UWIN")=1024,glo("Linux")=1024,glo("FreeBSD")=1024,glo("DragonFly")=1024,glo("CYGWIN")=1024
